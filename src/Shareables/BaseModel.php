...
abstract class BaseModel extends Model
{
    ...
    {
		if(isset(self::$__attGet[$method])) {
			$this->{self::$__attSet[$method]} = $parameters[0];
			return $this;
		} elseif(isset(self::$__attGet[$method])) {
            return $this->{self::$__attGet[$method]};
        } elseif(isset(self::$__methods[$method])) {
			$data = self::$__methods;
	...
	{
		if(isset(self::$__relationships[$key])) {
			$data = self::$__relationships;
